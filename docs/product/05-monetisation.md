...
`DECISION REQUIRED / LEGAL REVIEW REQUIRED`: product packaging/prices, taxes, refund policy, provider availability, app-store/channel rules, commission, creator payout terms. Read [phases](01-product-phases.md), [payment security](../security/05-payments-webhooks.md), [payment/payout gates](../compliance/04-payments-tax-payout-gates.md), [finance operations](../operations/03-finance-payout-operations.md), [payouts](../domains/payouts.md), [creator clubs](03-creator-private-clubs.md).
