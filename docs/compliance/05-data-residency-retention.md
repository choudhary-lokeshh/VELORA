...
Derived analytics, search, caches, media variants, AI context/memory/RAG/evaluation data, logs, traces, queues, DLQs, provider copies, and backups inherit source sensitivity. Derived form or encryption does not remove residency, retention, consent, or deletion obligations.
...
See [privacy/retention](../security/03-privacy-retention.md), [data ownership](../architecture/05-data-ownership.md), [account deletion](../flows/account-deletion.md), [AI context](../ai/03-ai-context-memory-rag.md), and [incident response](../operations/04-incident-response.md).
