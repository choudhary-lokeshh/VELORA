...
- Consumer Mobile: phases, consumer product, Consumer Mobile surface, notification flow, relevant domain/flow, Design/Figma set, ADR-0030 and the Consumer Mobile freeze report, security baseline/RBAC/privacy, API contracts, testing/release.
