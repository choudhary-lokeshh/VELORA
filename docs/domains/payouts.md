...
Four things move a creator's payout position and they arrive from different directions: a payout being reserved, one settling, one being released, and BILLING reversing a sale whose share was already accrued. The last does not originate here at all — it arrives as a published fact the relay applies.
