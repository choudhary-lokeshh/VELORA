...
CREATORS owns creator application, creator business/public profile, lifecycle, and creator eligibility to operate platform features. IDENTITY ASSURANCE owns creator-identity evidence. CREATORS does not own club memberships/content entitlements, customer charges, payout transfer truth, raw verification evidence, or ordinary discovery.
