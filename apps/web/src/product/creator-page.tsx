 ...
 *
 * Held at module scope rather than rebuilt inside the component, and exported
 * so the geometry can be checked without a browser: a malformed `d` is not a
 * React error and not a failed request. The browser simply refuses to draw the
 * shape and writes one line to the console, which is exactly how a broken rose
